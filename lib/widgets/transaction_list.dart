...
class _TransactionListState extends State<TransactionList> {
  Widget transactionList(CharProvider charProvider) {
    return charProvider.transactions.isEmpty
        ...
        : Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  transactions.sort((a, b) => b.metadata['timestamp'].compareTo(a.metadata['timestamp']));
                  ...
                  return InkWell(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(DateTime.fromMillisecondsSinceEpoch(transactions[index]
                                .metadata['timestamp'] as int).toString()),
                            Text(
                                "Events: ${transactions[index].sensorData.length}")
                          ],
                        ),
                      ));
                }),
